 ...
 * @author Jonathan
 */
public class AlterarContasReceber extends javax.swing.JDialog {

    Validar validar = new Validar();
    ContasReceberModel  receber = new ContasReceberModel();
    
    public AlterarContasReceber(java.awt.Frame parent, boolean modal,ContasReceberModel rec) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("Alterar Contas a Receber");
        ...
        panelContas.add(txtSacado, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 10, 350, -1));
        ...
        btnSalvar.setToolTipText("Alterar Cadastro");
        ...
        layout.setVerticalGroup(
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(layout.createSequentialGroup()
                .addComponent(panelContas, javax.swing.GroupLayout.DEFAULT_SIZE, 347, Short.MAX_VALUE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void txtVencimentoFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtVencimentoFocusLost
        try {
            ...
            if(receber.getVencimentoConta().before(receber.getEmissaoConta())){
            ...
            JOptionPane.showMessageDialog(panelContas,"Erro em datas!","Datas",JOptionPane.ERROR_MESSAGE);
        }
    ...
    public void carregarInfs(ContasReceberModel receber){
        txtSacado.setText(receber.getSacado());
        txtNumeroDocumento.setText(receber.getNumeroConta());
        txtValor.setText(validar.converterMoeda(receber.getValorConta()));
        txtEmissao.setText(validar.FormatarData(receber.getEmissaoConta()));
        txtVencimento.setText(validar.FormatarData(receber.getVencimentoConta()));
        if(receber.getStatus().equals("ABERTO")){
            cmbStatus.setSelectedIndex(0);
        }else{
            cmbStatus.setSelectedIndex(1);
        }
        txtObservacao.setText(receber.getObservacaoConta());        
    }
    ...
    private void alterar(){
        try {
            ...
            receber.setTipo("PAGAR");
            ContasReceberController receberController = new ContasReceberController();
            receberController.alterarContasReceber(receber);
            validar.exibirConfirmacaoCadastro("Contas à Receber");
            this.dispose();       
        }catch(ClassNotFoundException | SQLException | ParseException e){
            validar.exibirErroAlterarCadastro("Contas Receber");
