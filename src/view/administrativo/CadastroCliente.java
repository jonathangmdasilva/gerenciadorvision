...
public final class CadastroCliente extends javax.swing.JDialog{    
    ...
    public CadastroCliente(java.awt.Frame parent, boolean modal,UsuarioModel usu) {        
        super(parent, modal);
        initComponents();
        this.usuario = usu;
    ...
    private void initComponents() {
        ...
        panelBasico.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 30, -1, 20));

        jLabel2.setText("Cnpj.:");
        panelBasico.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 180, -1, 20));

        jLabel3.setText("Cpf.:");
        panelBasico.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 150, -1, 20));
        ...
        panelBasico.add(txtNome, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 30, 330, -1));
        ...
        panelBasico.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 60, -1, 20));
        ...
        panelBasico.add(txtEmail, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 60, 330, -1));

        lblTelefone.setText("Tel Um.:");
        panelBasico.add(lblTelefone, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 90, -1, 20));
        ...
        panelBasico.add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 90, -1, 20));
        panelBasico.add(txtTelefoneDois, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 90, 140, -1));
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(panelBasico, javax.swing.GroupLayout.PREFERRED_SIZE, 225, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
    ...
    private void txtNumeroFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtNumeroFocusLost
        validar.validarNumeros(txtNumero);        
    }//GEN-LAST:event_txtNumeroFocusLost

    private void txtCpfFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtCpfFocusLost
        val = validar.validarCPF(txtCpf.getText());
        if(!val)txtCpf.requestFocus();        
    }//GEN-LAST:event_txtCpfFocusLost

    private void txtCnpjFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtCnpjFocusLost
        val = validar.validarCNPJ(txtCnpj.getText());        
        if(!val)txtCnpj.requestFocus();          
    }//GEN-LAST:event_txtCnpjFocusLost

    public void consultar(){
        this.dispose();
        ConsultaCliente cc = new ConsultaCliente(usuario);                
    }
    ...
    private void inserirCliente(){                        
        try { 
            ...
            telefoneUm = txtTelefoneUm.getText();
            telefoneDois = txtTelefoneDois.getText();
            ...
            clienteController.inserirClient(nome,tipo,cpf,cnpj,status);                                    
            idCliente = clienteController.listarQtdClientes();
                        
            //CONTATO
            ContatoController contatoController = new ContatoController();
            contatoController.inserirContatoCliente(email, telefoneUm, telefoneDois,idCliente);            
            
            //ENDEREÇO
            EnderecoController enderecoController = new EnderecoController();
            enderecoController.inserirEnderecoCliente(logradouro, numero, bairro, cidade, estado,idCliente);            

            //VALIDAR SE CADASTRO FOI FEITO COM SUCESSO
            validar.exibirConfirmacaoCadastro("Cliente");     
            dispose();            
        } catch (ClassNotFoundException | NumberFormatException | SQLException | NullPointerException n) {
            validar.exibirErroCadastro("Cliente");
        }        
    }    
