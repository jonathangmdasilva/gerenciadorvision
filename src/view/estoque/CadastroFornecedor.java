...
public class CadastroFornecedor extends javax.swing.JDialog {
    ...
    String razao,cnpj,email,telefoneUm,telefoneDois,logradouro,cidade,bairro;
    Integer status,numero,estado,idFornecedor;
    UsuarioModel usuario;
    
    public CadastroFornecedor(java.awt.Frame parent, boolean modal,UsuarioModel us) {
        super(parent, modal);
        this.usuario = us;
        initComponents();                
    ...
    private void initComponents() {
        ...
        panel_forne.add(txtEmail, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 140, 280, -1));
        ...
        panel_forne.add(jLabel16, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 230, -1, 20));

        jLabel13.setText("Numero");
        panel_forne.add(jLabel13, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 200, -1, 20));
        panel_forne.add(txtNumero, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 200, 150, -1));
        ...
        panel_forne.add(cmbEstado, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 230, 150, -1));
        ...
        btnConsulta.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/Procurar.png"))); // NOI18N
    ...
    private void inserirFornecedor() throws SQLException, ClassNotFoundException{
        try {
            ...
            fornecedorController.inserirFornecedor(razao,cnpj,status);                                    
            idFornecedor = fornecedorController.listarQtdFornecedores();            
            //CONTATO
            ContatoController contatoController = new ContatoController();
            contatoController.inserirContatoFornecedor(email, telefoneUm, telefoneDois,idFornecedor);            
            System.out.println("PASSOU");
            //ENDEREÇO
            EnderecoController enderecoController = new EnderecoController();
            enderecoController.inserirEnderecoFornecedor(logradouro, numero, bairro, cidade, estado,idFornecedor);            
